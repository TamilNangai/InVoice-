...
const Sidebar = () => {
    ...
    return (
        <>
            <div className={`sticky  flex flex-col justify-between items-center h-[1260px] rounded-tr-[16px] rounded-br-[16px] border-[2.5px] border-[#000000] bg-[#FFFFFF] shadow-[0px_16px_44px_rgba(0,0,0,0.07)] gap-6 transition-all duration-300 ${isExpanded ? "w-[276px]" : "w-[64px]"
                }`}>
