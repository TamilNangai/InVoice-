        ...
        <div className=" fixed bg-black/20 inset-0 flex justify-center  items-center z-50 ">
          <section className="border-2 border-[#136CEDCC] w-8/12 h-fit p-5 rounded-lg bg-white ">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4 mt-4">  
              ...
              <section
                onClick={() => setSelectedRoute("/internship-invoice")}
                className={`border-2  h-180px flex flex-col justify-between pb-4  rounded-lg cursor-pointer
                ${selectedRoute === "/internship-invoice" ? "border-blue-500 bg-blue-50" : "border-black"}`}
              >
                <div className="flex items-center justify-center">
                  <img className="border border-black rounded-xl w-12 h-12 mt-4" src={props.popup1} />
            ...
            <button
              onClick={() => setShow(false)}
              className="h-[45px] w-auto px-5  py-2 rounded-lg border-2 border-gray-400 hover:bg-gray-100 flex items-center justify-center text-md sm:text-lg md:text-xl font-iceberg"
            >
              Cancel
            </button>

            <div className="h-[39px] flex items-center" onClick={handleContinue}>
              <Buttons h1="Continue" h2="" src1={props.src2} src2="" />
            </div>
