      ...
      {show && (
        <div className=" fixed bg-black/20 inset-0 flex justify-center  items-center z-50">
          <section className="border-2 border-[#136CEDCC] w-8/12 h-fit p-5 rounded-lg bg-white">
            ...
            <h1 className="font-iceberg xl:text-[28px] md:text-[22px]  pl-10 mt-5 h-12 font-extralight border-b border-black">
              {props.h1}
            </h1>

            <p className="text-center xl:text-[18px] md:text-[14px]  font-sanchez mt-3">
              {props.para1}
            </p>
            <p className="text-center xl:text-[18px] md:text-[14px]  font-sanchez">
              {props.para6}
            </p>
            ...
            <div className="flex md:space-x-3 xl:space-x-10 items-center justify-center mt-4">
              ...
              >
                ...
                <h1 className="text-center md:text-[12px] lg:text-[17px] font-iceberg mt-2">{props.h2}</h1>
                <p className="text-center font-sanchez xl:text-[15px] md:text-[10px] px-1">{props.para2}</p>
              </section>
              ...
              >
                ...
                <h1 className="text-center md:text-[12px] lg:text-[17px] font-iceberg mt-2">{props.h3}</h1>
                <p className="text-center font-sanchez xl:text-[15px] md:text-[10px]  px-1">{props.para3}</p>
              </section>
              ...
              >
                ...
                <h1 className="text-center md:text-[12px] lg:text-[17px] font-iceberg mt-2">{props.h4}</h1>
                <p className="text-center font-sanchez xl:text-[15px] md:text-[10px]  px-1">{props.para4}</p>
              </section>
              ...
              >
                ...
                <h1 className="text-center md:text-[12px] lg:text-[17px] font-iceberg mt-2">{props.h5}</h1>
                <p className="text-center font-sanchez xl:text-[15px] md:text-[10px]  px-1">{props.para5}</p>
              </section>
