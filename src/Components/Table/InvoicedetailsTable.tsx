                ...
                <BaseTable.Body>
                    {currentRows.map((item) => (
                        <BaseTable.Row key={item.no}>
                            <BaseTable.Cell>
                                <div className="font-sanchez text-[16px]">{item.no}</div>
                            </BaseTable.Cell>

                            <BaseTable.Cell>
                                <span className={`font-iceberg text-[14px] ${typeBadge(item.type)}`}>
                                    {item.type}
                                </span>
                            </BaseTable.Cell>

                            <BaseTable.Cell>
                                <div className="font-medium font-iceberg text-[18px]">{item.name}</div>
                                <div className="text-[12px]  font-sanchez text-gray-600">
                                    {item.sub}
                                </div>
                            </BaseTable.Cell>
                            ...
                            <BaseTable.Cell>
                                <span
                                    className={`${statusColor(
                                        item.status
                                    )} font-medium text-[16px]  font-sanchez`}
                                >
                                    • {item.status}
                                </span>
                            </BaseTable.Cell>
