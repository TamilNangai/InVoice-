...
const ProductForm: React.FC<Props> = ({ data, setData }) => {
  ...
  return (
    ...
    <form className="p-6 rounded-2xl border border-black shadow-[5px_5px_15px_rgba(0,0,0,0.3)]">
      ...
      <h2 className="text-xl font-iceberg mb-6 font-bold ">
        Service Details
      </h2>

      <div className="grid grid-cols-10 gap-3 font-iceberg text-lg">
      ...
      {data.map((row, index) => (
        ...
        <div
          key={index}
          className="grid grid-cols-10 items-center gap-3 mt-3 font-sanchez text-sm"
        >
